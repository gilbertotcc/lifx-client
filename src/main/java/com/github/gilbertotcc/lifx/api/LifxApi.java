...
public interface LifxApi {
  ...
  Call<Results<Result>> setLightsStateDelta(final @Path("selector") LightsSelector lightsSelector,
                                            final @Body StateDelta stateDelta);

  @POST("/v1/lights/{selector}/toggle")
  Call<Results<Result>> togglePower(final @Path("selector") LightsSelector lightsSelector,
                                    final @Body TogglePower togglePower);

  @POST("/v1/lights/{selector}/effects/breathe")
  Call<Results<Result>> breatheEffect(final @Path("selector") LightsSelector lightsSelector,
                                      final @Body BreatheEffect breatheEffect);

  @POST("/v1/lights/{selector}/effects/pulse")
  Call<Results<Result>> pulseEffect(final @Path("selector") LightsSelector lightsSelector,
