...
public class LifxClientImpl implements LifxClient {
    ...
    public List<Result> setLightsState(final LightsSelector lightsSelector, final State state) throws LifxRemoteException {
        log.info("Set lights state of {} to {}", lightsSelector.getIdentifier(), ReflectionToStringBuilder.toString(state, ToStringStyle.JSON_STYLE));
    ...
    public List<Result> setLightsStateDelta(final LightsSelector lightsSelector, final StateDelta stateDelta) throws LifxRemoteException {
        log.info("Set lights state delta of {} to {}", lightsSelector.getIdentifier(), ReflectionToStringBuilder.toString(stateDelta, ToStringStyle.JSON_STYLE));
    ...
    public List<Result> doBreatheEffect(final LightsSelector lightsSelector, final BreatheEffect breatheEffect) throws LifxRemoteException {
        log.info("Do breathe effect with {}. Settings: {}", lightsSelector.getIdentifier(), ReflectionToStringBuilder.toString(breatheEffect,
    ...
    public List<Result> doPulseEffect(final LightsSelector lightsSelector, final PulseEffect pulseEffect) throws LifxRemoteException {
        log.info("Do pulse effect with {}. Settings: {}", lightsSelector.getIdentifier(), ReflectionToStringBuilder.toString(pulseEffect,
                ToStringStyle.JSON_STYLE));
